...
s0_skydome = true
s0_skydome_image = /home/erik/Dropbox/Apps/Desktoppr/htttc.jpg
...
s0_position_matches = title=Whisker Menu;
s0_position_x_values = -1;
s0_position_y_values = -1;
...
[core]
s0_active_plugins = core;composite;opengl;decor;regex;mousepoll;imgjpeg;grid;compiztoolbox;wobbly;place;animation;staticswitcher;move;resize;freewins;cube;td;expo;rotate;
